    ...
    return (
        <div id="banner" className="mb-4 text-center">
            { 
                ...
                <div className="px-3 py-3"><strong>Attention</strong>: We are currently experiencing network issues with our mainnet. We will be recovering the network and will keep everyone posted on any progress.</div>
                </> :
